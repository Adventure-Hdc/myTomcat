...
import com.hou.mytomcat.util.ReadBytes;
...
public class RequestBIO extends BaseRequest {
    ...
    private Connector connectorBIO;
    //标识符 --- 是否跳转
    private boolean forwarded;
    private Map<String, Object> attributesMap;

    public RequestBIO(Socket socket, Connector connectorBIO) throws IOException {
        this.socket = socket;
        this.connectorBIO = connectorBIO;
    ...
    private void parseContext() {
        Service service = connectorBIO.getService();
    ...
    private void parseHttpRequest() throws IOException {
        ...
        byte[] bytes = ReadBytes.readBytes(is, false);
